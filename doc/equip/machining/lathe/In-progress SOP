...
- The power is off. (red switch)
- The cover over the chuck is down.
- There is nothing already present in the chuck.
...
To power up the lathe:
  ...
  3. The green power indicator lights and the spindle speed readout illuminates.

To start the lathe:
  1. Press the green Start button.
  2. Press a direction control button if the spindle is not turning the direction you want.
