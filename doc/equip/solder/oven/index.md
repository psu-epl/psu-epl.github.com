---
title: T200N Desktop Solder Oven
layout: sop
author: 
date: 2019-12-05
---
...
1. Hit "Start".
   - Monitor the red temperature graph - it should basically mirror the green set points.
   - If you do not see the red temperature graph after hitting the start button, the oven may not be connected. restart the oven and      attemp to connect to the COM port again
...
1. When you're done:
   - Switch off the oven (switch on back, upper right corner).
