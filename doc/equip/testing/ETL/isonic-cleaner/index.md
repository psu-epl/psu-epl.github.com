...
- You can find the manual [here](/doc/equip/testing/ETL/isonic-cleaner/iSonic-P4810-user manual-181012-s.pdf)
...
# Using this Machine
There are many things this system can clean and there are some items that may be damaged during the cleaning process. Make sure your item is not on the following list. 
...
- Generally use thin, lightweight and stiff containers.
- Plastic containers – A plastic container with the same weight as a metal container will absorb more ultrasonic energy. Using thin and stiff containers will help to reduce energy absorption.
- Aluminum containers- Absorbs about 20% of ultrasonic energy.
- Glass beakers- Absorb about 15% of ultrasonic energy. Do not use thick-walled glass containers such as mason jars or Pyrex containers.
- Stainless steel containers –Absorbs about 8% of ultrasonic energy.

////////////////////insert page 11 lower image//////////////////////

### Enhanced Cleaning
This cleaning method is best for cleaning debris accumulated over a long time and for greasy or heavily soiled items. 

/////////////add page 9 upper image////////////////

1. Put the items in the cleaning tank directly. NOTE: Do not put the items on top of each other to avoid rubbing during cleaning.
1. Add water to level between MIN and MAX and above the area to be cleaned.
1. Add 1 tablespoon (20mL) of dishwashing liquid.
1. Press Heater to turn on the heater. Press Heater again to turn off the heater when the water temperature reached 104 degrees F (40 C) after about 20 minutes. NOTE: heat is applied to better clean the item, if your item is susceptible to heat damage you do not need to use this feature.
1. Press SET button to set the timer to 10 minutes. 
1. Press On/Off button to start cleaning. Grease will dissipate and appear to be like black smoke in the water.
1. Change water (no soap) and wash the items for another 3 minutes to remove the residual debris and the detergent.

### Special Cleaning
This cleaning method is best for cleaning items like silver, copper, or brass to remove oxidation.

///////////////add page 9 lower image//////////////////////////

1. Put the items in the basket and then in the tank.
1. Add water to a level between MIN and MAX and above the area to be cleaned.
1. Add special solution that can remove silver or copper oxidation according to the ratio recommended (typically 1:10). Use the special solutions according to the instructions for bass cartridges.
1. Press Heater to turn on the heater. Press Heater to cancel heating when the water temperature reaches about 122 degrees F (50 C) after approximately 30 minutes. 
1. Press SET button to set the timer to 15 minutes.
1. Press Function button to select Degas function.
1. Press On/Off to start degassing. After 90 seconds, it changes over to normal cleaning.
1. When cleaning is done, remove the basket and the items. If there are large quantities of items and some debris remains, add 5 minutes and repeat the cleaning.
1. Change water and wash the items for 3 minutes to remove the residual chemicals.
...
## Cleanup
1. Pour the water out through the pouring recess.
1. Clean and wipe the tank.
1. Put away any soap or solutions.

# Tips and Tricks
- Heat is applied to better clean the item, if your item is susceptible to heat damage you do not need to use this feature.
- If you use acetone avoid coming in contact with the plastic housing to prevent corrosion. Also use a glass or metal container for the items/acetone.
- When the liquid temperature reaches 140 degrees F (60 degrees C), the heater will turn off automatically.
